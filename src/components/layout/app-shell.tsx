...
const SanvedanaLogo = ({ scrolled = false }: { scrolled?: boolean }) => (
  <Link href="/" className="flex items-center gap-2 font-semibold transition-all duration-300">
    <div className={cn("relative w-auto h-16", { 'h-10': scrolled })}>
      <div className={cn("absolute inset-0 transition-opacity duration-300", scrolled ? 'opacity-0' : 'opacity-100')}>
        ...
        >
            ...
            <path d="M228.31,104.59h-4.63l-2.7-7.92h-17.37l-2.7,7.92h-4.63l13.68-40.42h5.36l13,40.42Zm-16.18-11.42h9.76l-4.88-14.86h-0.09l-4.79,14.86Z" fill="currentColor" />
            <path d="M185.74,64.17c-13.4,0-21.72,8.19-21.72,20.31,0,12.08,8.28,20.1,21.68,20.1,13.44,0,21.72-8,21.72-20.06,0-12.16-8.28-20.35-21.68-20.35Zm0,36.5c-10.7,0-16.71-6.22-16.71-16.19,0-9.97,6-16.23,16.71-16.23,10.74,0,16.72,6.26,16.72,16.23,0,9.97-6,16.19-16.72,16.19Z" fill="currentColor"/>
            <path d="M265.23,64.17v40.42h-4.59v-18.1h-13.77v18.1h-4.59v-40.42h4.59v18.1h13.77v-18.1h4.59Z" fill="currentColor"/>
            <path d="M331,64.17h4.63l-13.41,20.14,14,20.28h-5l-11.66-17.37-2.66,2.37v15h-4.59v-40.42h4.59v15.33l13.1-15.33Z" fill="currentColor"/>
            <path d="M304.5,84.5c0-11.5,8-20.5,19.5-20.5s19.5,9,19.5,20.5-8,20.5-19.5,20.5-19.5-9-19.5-20.5Zm35,0c0-9-6-16.5-15.5-16.5s-15.5,7.5-15.5,16.5,6,16.5,15.5,16.5,15.5-7.5,15.5-16.5Z" fill="currentColor"/>
            <path d="M375,64.5v40h-4v-40h-10v-3.5h24v3.5h-10Z" fill="currentColor"/>
        </svg>
      </div>
      <div className={cn("absolute inset-0 flex items-center justify-center transition-opacity duration-300", scrolled ? 'opacity-100' : 'opacity-0')}>
          <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-foreground">
              <path d="M4.125 4.125L9.875 9.875M9.875 4.125L4.125 9.875" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M14.125 14.125L19.875 19.875M19.875 14.125L14.125 19.875" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
      </div>
    </div>
  </Link>
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-background">
      ...
      <header className={cn("sticky top-0 z-50 flex h-24 w-full items-center px-4 md:px-6 transition-all duration-300 bg-transparent")}>
